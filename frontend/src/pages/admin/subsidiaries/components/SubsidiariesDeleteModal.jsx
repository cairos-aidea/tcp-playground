...
const SubsidiariesDeleteModal = ({ subsidiaryId, setModalVisible, handleDelete }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40">
      <div className="bg-white z-50 p-6 space-y-4 rounded-lg shadow-lg w-full max-w-md border border-solid border-gray-200">
        <h3 className="text-lg font-semibold mb-4 text-center">Delete Subsidiary</h3>
...
export default SubsidiariesDeleteModal;
